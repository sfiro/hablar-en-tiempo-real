...
Copia idéntica de `../v3/pico_serial.py`, compatible además con `v4/main.py` (que
ignora el campo EMOCION si se envía). Cada versión de este proyecto es autónoma y no
