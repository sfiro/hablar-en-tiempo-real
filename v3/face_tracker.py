...
cuando se integre con la conversación de voz (Hito 2 de PLAN-v3.md).
    ...
    try:
        while True:
            ...
            if mostrar_ventana:
                ...
                cv2.imshow("Rastreo Facial (v3, prueba standalone)", frame)
...
def main():
    parser = argparse.ArgumentParser(
        description="Prueba standalone del rastreo facial (Hito 1 de v3).")
