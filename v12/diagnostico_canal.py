...
#
# Nota heredada, no corregida en v12 (fuera de alcance de esta versión): este
# fichero sigue usando el controlador PCA9685 por I2C, igual que en v9 y en
...
# existía antes de v12; no se ha usado ni validado con el hardware actual (sin
