...
Copia idéntica de `../v10/pico_serial.py` (que ya está adaptada para Linux/
Raspberry Pi OS: v10 fue la primera versión en cambiar de cliente Mac→Pi 5). v12
reutiliza esa adaptación sin cambios porque su cliente es la misma plataforma
(Raspberry Pi 5). Compatible con `main.py` en esta misma carpeta, que usa el
campo EMOCION para decidir la expresión facial. Cada versión de este proyecto
es autónoma y no importa código de otra carpeta de versión — ver CLAUDE.md.
