# v5 (HISTÓRICO — no usar) — Firmware MicroPython con PCA9685, archivado.
#
# ⚠️  Esta versión NO se usa. El main.py real de v5 genera el PWM directo desde
# los pines de la Pico, sin PCA9685. Se conserva este fichero solo como referencia
# histórica de por qué se abandonó ese enfoque — ver README-v5.md, sección
# "Historial de depuración", para la cronología completa.
#
# Problemas confirmados en hardware real con este código, ambos resueltos al
# quitar el PCA9685 (ver main.py):
#   1. Temblor aleatorio en todos los servos — primero solo al encender (arreglado
#      con /OE, ver más abajo), después periódico cada vez que parpadeaba, y
#      finalmente continuo tras intentar ajustar la temporización del parpadeo.
#   2. El eje PAN (rotación izquierda/derecha) nunca llegó a moverse.
#
