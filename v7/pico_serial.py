...
Copia idéntica de `../v6/pico_serial.py` (que a su vez viene de v5, v4, v3), compatible
además con `main.py` en esta misma carpeta (que ignora el campo EMOCION si se envía).
Cada versión de este proyecto es autónoma y no importa código de otra carpeta de
versión — ver CLAUDE.md.
"""
