...
cuando se integre con la conversación de voz (ver PLAN-v7.md).

Copia idéntica de `../v6/face_tracker.py` (que a su vez viene de v5, v4, v3, y
    ...
    try:
        while True:
            ...
            if mostrar_ventana:
                ...
                cv2.imshow("Rastreo Facial (v7, prueba standalone)", frame)
...
def main():
    parser = argparse.ArgumentParser(
        description="Prueba standalone del rastreo facial (ver PLAN-v7.md).")
