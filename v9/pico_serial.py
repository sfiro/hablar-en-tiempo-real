...
Copia idéntica de `../v8/pico_serial.py` (que a su vez viene de v7, v6, v5, v4,
v3), compatible además con `main.py` en esta misma carpeta — que, a diferencia
de v3-v7, ya no ignora el campo EMOCION: lo usa para decidir la expresión
facial (ver la cabecera de `main.py`). Cada versión de este proyecto es
autónoma y no importa código de otra carpeta de versión — ver CLAUDE.md.
"""
