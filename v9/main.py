# v9 — Firmware MicroPython para la Raspberry Pi Pico.
#
...
#
# Sin cambios de lógica respecto a v8 — este firmware ya aceptaba LR/UD reales
# por serial (para las 7 expresiones que no fijan la mirada) sin distinguir si
# venían de un rastreo real o de un valor fijo. La novedad de v9 está del lado
# del Mac: v8/webrtc_server.py mandaba siempre "90,90" junto al EMOCION porque
# no tenía cámara; v9/webrtc_server.py sí la tiene (face_tracker.py, retomado de
# v7) y manda la posición real del rostro detectado. Este fichero no necesitó
# ningún cambio para que eso funcione.
#
...
# el Mac (v9/webrtc_server.py) envíe la emoción detectada en cada frase de la
# conversación (ver sentiment_analyzer.py y el mapeo a las 10 emociones de la
# Pico en README-v9.md) — la cara reacciona a la conversación, no a un
# temporizador ciego. Los offsets de párpados/cuello por emoción son los mismos
# de v6/v7 (OFFSETS_EMOCIONES, con FELIZ y SOSPECHA recalculados — ver el
# comentario junto a OFFSETS_EMOCIONES), aplicados sobre una posición de reposo
# fija de los párpados, no completamente abierta (v9 no sincroniza los párpados
...
# construidas desde v6, sin cambios aquí. Para las otras 7, ahora en v9 esa
# mirada sí es la del rostro rastreado de verdad.
#
...
# descrito arriba. El Mac (pico_serial.py, copia propia de v9) no necesita
...
# ==========================================
print("v9: iniciando (rastreo de ojos + cuello + parpadeo + expresión dirigida por EMOCION)...")
...
def actualizar_objetivo_expresion():
    ...
    de los párpados (v9 no sincroniza párpados con la mirada todavía) y, salvo
