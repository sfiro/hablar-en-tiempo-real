...
Copia de v1/realtime_voice.py, sin cambios de lógica: `sounddevice`/PortAudio
habla con el dispositivo de audio por defecto del sistema, sea macOS o
Raspberry Pi OS — en la Pi 5 hace falta fijar el micro/parlante USB como
predeterminados antes de arrancar esto (ver README-v11.md). Esta es la
alternativa de terminal, sin cancelación de eco real (usa los paliativos de
v1: `MicGate`, `BargeInDetector`, half-duplex) — `webrtc_server.py`, con el
navegador, es la vía recomendada también aquí.
