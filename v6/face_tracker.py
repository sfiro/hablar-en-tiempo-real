...
cuando se integre con la conversación de voz (ver PLAN-v6.md).
    ...
    try:
        while True:
            ...
            if mostrar_ventana:
                ...
                cv2.imshow("Rastreo Facial (v6, prueba standalone)", frame)
...
def main():
    parser = argparse.ArgumentParser(
        description="Prueba standalone del rastreo facial (ver PLAN-v6.md).")
