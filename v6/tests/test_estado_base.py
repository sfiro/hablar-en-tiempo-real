...
def test_duty_de_90_grados_coincide_con_main_py():
    # Mismo valor que test_main_math.py::test_duty_en_los_extremos_y_el_centro
    # para 90°: si esto diverge, estado_base.py y main.py ya no llevan los
    # servos a la misma posición física para el mismo ángulo.
