# v13 — Utilidad: lleva los 8 servos a la posición base (90°) y los mantiene ahí.
#
# Copia idéntica de ../v12/estado_base.py (== ../v9/estado_base.py).
# Independiente de main.py (que hace todo el rastreo + cuello + parpadeo).
# Pensada para dos casos:
