...
Sin cambios respecto a v12/face_tracker.py: mismos ANCHO/ALTO (1296x972,
calibrados para la cámara CSI real) y mismo filtro anti-falso-positivo de
80px (ver ../v12/MODIFICACIONES-LOCALES.md para el detalle de esos hallazgos).
...
def test_elige_el_rostro_mas_grande_no_el_primero():
    """Hallazgo real en hardware (v12, 23/08/2026): un falso positivo fijo y
    pequeño del fondo aparecía en rostros[0] y secuestraba la mirada.
    procesar() debe elegir el de mayor área, sin importar el orden en que la
    cascada los reporte."""
    t = FaceTracker(alpha=1.0)
