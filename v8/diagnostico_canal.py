# Diagnóstico de un solo canal del PCA9685, sin nada de rastreo ni serial de por
# medio. Sirve para aislar si un eje que "no funciona" es un problema de firmware
